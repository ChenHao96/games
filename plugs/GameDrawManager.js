window.GameDrawManager = (() => {
    ...
    splashScene._init = function () {
        ...
        splashLayout._init = function () {
            ...
            this.providedText.setFontSize(64 * textScale)
    ...
    GameDrawManager.run = () => {
        ...
        logoSvg.setAttribute("width", baseWidth + "")
        logoSvg.setAttribute("height", baseWidth + "")
        const svg_xml = (new XMLSerializer()).serializeToString(logoSvg)
        const logo = new Image()
        logo.src = logoPath = "data:image/svg+xml;base64," + window.btoa(svg_xml)
        logo.onload = () => {
